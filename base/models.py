...
class Product(models.Model):
    ...
    genre_two = models.ForeignKey(Genre, on_delete=models.CASCADE, blank=True, null=True, related_name='genre_two')
    genre_three = models.ForeignKey(Genre, on_delete=models.CASCADE, blank=True, null=True, related_name='genre_three')
